-- Migration: patch_pack_v2_schema_indices_rpcs_fixed
-- Created at: 1762782273
...
-- Atualizar valores existentes em feriados
UPDATE feriados 
SET dia_mes = EXTRACT(DAY FROM data)::INTEGER, 
...
BEGIN
  WHILE cursor_time < end_time LOOP
    ...
    WHERE a.status <> 'cancelado'
      ...
      AND a.data_agendamento + (a.duracao_minutos || ' minutes')::INTERVAL > cursor_time;
