-- Migration: patch_v3_part5_feriados_sem_triggers
-- Created at: 1762801683

-- Migration: patch_v3_part5_feriados_sem_triggers
-- Parte 5: Feriados - Desabilitar triggers e atualizar dados

-- Desabilitar triggers temporariamente
DROP TRIGGER IF EXISTS trigger_sincronizar_agendamento_feriado ON feriados;
DROP TRIGGER IF EXISTS trigger_desbloquear_agendamento_feriado ON feriados;
...
-- Recriar função sincronizar_agendamento_feriado com tipos corretos
...
-- Recriar triggers
CREATE TRIGGER trigger_sincronizar_agendamento_feriado
    AFTER INSERT OR UPDATE ON feriados
    FOR EACH ROW
    EXECUTE FUNCTION sincronizar_agendamento_feriado();

CREATE TRIGGER trigger_desbloquear_agendamento_feriado
    AFTER DELETE ON feriados
    FOR EACH ROW
    EXECUTE FUNCTION desbloquear_agendamento_feriado();
...
-- Resultado
SELECT 'Parte 5: Feriados com Triggers - Concluído' AS result;;